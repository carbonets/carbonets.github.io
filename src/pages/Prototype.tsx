      ...
      <div className='flex flex-col items-center mx-auto font-montserrat text-white font-bold mb-28'>
        ...
        <div className='flex flex-col md:flex-row gap-8 items-center text-center md:text-left max-w-[65rem] p-4 md:p-0 mb-4'>
          <div className="m-4 space-y-8">
            ...
            <img src="src\assets\DACC.png" alt="DACC" className="max-h-[20rem] max-w-[20rem] rounded-xl md:hidden mx-auto"/>
          ...
          <img src="src\assets\DACC.png" alt="DACC" className="max-h-[20rem] max-w-[20rem] lg:max-h-[25rem] lg:max-w-[25rem] hidden md:block rounded-xl"/>
        </div>
        <div className='flex flex-col md:flex-row gap-8 items-center text-center md:text-left max-w-[65rem] p-4 md:p-0'>
          <img src="src\assets\Monolith.png" alt="DACC" className="max-h-[20rem] max-w-[20rem] lg:max-h-[25rem] lg:max-w-[25rem] hidden md:block rounded-xl"/>
          <div className="m-4 space-y-8">
            <h2 className='text-[1.5rem] lg:text-[2.5rem]'>{t('subtitleKeyElement')}</h2>
            <img src="src\assets\Monolith.png" alt="DACC" className="max-h-[20rem] max-w-[20rem] rounded-xl md:hidden mx-auto"/>
            <p className='text-[1rem] lg:text-[1.5rem] font-light'>
        ...
        <div className='flex flex-col md:flex-row gap-8 items-center text-center md:text-left max-w-[65rem] p-4 md:p-0 mb-4'>
          <div className="m-4 space-y-8">
            ...
            <img src="src\assets\BondBreak.png" alt="DACC" className="max-h-[20rem] max-w-[20rem] rounded-xl md:hidden mx-auto"/>
            <p className='text-[1rem] lg:text-[1.5rem] font-light'>
          ...
          <img src="src\assets\BondBreak.png" alt="DACC" className="max-h-[20rem] max-w-[20rem] lg:max-h-[25rem] lg:max-w-[25rem] hidden md:block rounded-xl"/>
        </div>
        <div className='flex flex-col md:flex-row gap-8 items-center text-center md:text-left max-w-[65rem] p-4 md:p-0 mb-4'>
          <img src="src\assets\CFD.png" alt="DACC" className="max-h-[20rem] max-w-[20rem] lg:max-h-[25rem] lg:max-w-[25rem] hidden md:block rounded-xl"/>
          <div className="m-4 space-y-8">
            <h2 className='text-[1.5rem] lg:text-[2.5rem]'>{t('subtitleAirflow')}</h2>
            <img src="src\assets\CFD.png" alt="DACC" className="max-h-[20rem] max-w-[20rem] rounded-xl md:hidden mx-auto"/>
            <p className='text-[1rem] lg:text-[1.5rem] font-light'>
        ...
        <div className='flex flex-col md:flex-row gap-8 items-center text-center md:text-left max-w-[65rem] p-4 md:p-0 mb-4'>
          <div className="m-4 space-y-8">
            ...
            <img src="src\assets\co2Sensor.png" alt="DACC" className="max-h-[20rem] max-w-[20rem] rounded-xl md:hidden mx-auto"/>
            <p className='text-[1rem] lg:text-[1.5rem] font-light'>
          ...
          <img src="src\assets\co2Sensor.png" alt="DACC" className="max-h-[20rem] max-w-[20rem] lg:max-h-[25rem] lg:max-w-[25rem] hidden md:block rounded-xl"/>
        </div>
        <div className='flex flex-col md:flex-row gap-8 items-center text-center md:text-left max-w-[65rem] p-4 md:p-0 mb-4'>
          <img src="src\assets\solar-panel.png" alt="solar" className="max-h-[20rem] max-w-[20rem] lg:max-h-[25rem] lg:max-w-[25rem] hidden md:block rounded-xl"/>
          <div className="m-4 space-y-8">
            <h2 className='text-[1.5rem] lg:text-[2.5rem]'>{t('subtitleEnergy')}</h2>
            <img src="src\assets\solar-panel.png" alt="solar" className="max-h-[20rem] max-w-[20rem] rounded-xl md:hidden mx-auto"/>
            <p className='text-[1rem] lg:text-[1.5rem] font-light'>
        ...
        <div className='flex flex-col md:flex-row gap-8 items-center text-center md:text-left max-w-[65rem] p-4 md:p-0 mb-4'>
          <div className="m-4 space-y-8">
            ...
            <img src="src\assets\skeleton.png" alt="DACC" className="max-h-[20rem] max-w-[20rem] rounded-xl md:hidden mx-auto"/>
            <p className='text-[1rem] lg:text-[1.5rem] font-light'>
          ...
          <img src="src\assets\skeleton.png" alt="DACC" className="max-h-[20rem] max-w-[20rem] lg:max-h-[25rem] lg:max-w-[25rem] hidden md:block rounded-xl"/>
        </div>
      </div>
    </>
  )
